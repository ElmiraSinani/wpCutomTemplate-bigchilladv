    ...
    <form action="" id="booking-form"  method="post">
       ...
       <div class="form_container_full">
            ...
            <select class="full" name="trips_fields" id="trips_fields">
              <?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
                <?php
                    ...
                    $maxNum    = get_post_meta($my_query->post->ID, '_max_num_val', true );
                ?>
                <option data-trip-price="<?php echo $price; ?>" data-trip-days="<?php echo $duration ?>" data-max-num="<?php echo $maxNum; ?>" value="<?php the_title(); ?>">
                    <?php the_title(); ?>
                </option>
            <?php endwhile; ?>
            </select>
        ...
        <div class="formItem"> 
            ...
            <select class="full" name="max_num_field" id="max_num_fields">
        ...
        <div class="summary">
            ...
            <div class="rightSum">
                ...
                <input name="acc_fee_field" type="text" readonly id="accomodation-cost" value=""/><br />
