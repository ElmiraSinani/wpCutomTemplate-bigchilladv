...
<div id="middle" class="cols2">
    <div class="container_12">
        ...
        <div class="fuul-content">
            ...
            <div class="title m20">
                <h1><a href="<?php  echo get_post_type_archive_link('trips'); ?>">See all Trips</a></h1>
                <span class="title_right count"><?php echo $count_posts->publish; ?> available offers</span>
            </div>
            ...
            <?php 
                ...
                $discount = get_post_meta(get_the_ID(), '_discount_val', true);
                $discountBg = get_post_meta(get_the_ID(), '_discount_color_val', true);
                ...
                <div class="list-item">        	
                    <div class="re-image list_img">
                        ...
                        <?php  if(isset($discount) && $discount != '' ){ ?>
                            <span class="discount_txt" style="background: <?php echo $discountBg; ?>"> <?php echo $discount; ?></span>
                        <?php } ?>
                        </a>
